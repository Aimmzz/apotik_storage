...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
					...
					<div class="x_content">
						...
						<table class="table table-striped" id="obat">
							...
							<tbody>
								...
								<td><a href="<?php echo $admin_url; ?>masterobat/form_edit.php?id_obat=<?php echo $data['id_obat'];?>">
								<button class="btn btn-warning">
									<i class="fa fa-edit"></i>
								</button></a>
								
								<a href="<?php echo $admin_url; ?>masterobat/hapus.php?id_obat=<?php echo $data['id_obat'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>masterobat/form_tambah.php">
