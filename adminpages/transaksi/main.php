...
<div class="right_col" role="main">
    ...
    <a href="<?php echo $admin_url; ?>transaksi/index.php?id_transaksi=<?php echo $data['kd_transaksi'];?>" target="_blank"><button class="btn btn-primary"><i class="fa fa-print"></i> Print</button></a>
</div>
