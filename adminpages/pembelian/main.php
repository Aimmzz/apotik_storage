...
<div class="right_col" role="main">
	...
	<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>pembelian/index.php?id_pembelian=<?php echo $data['id_pembelian'];?>" target="_blank"><button class="btn btn-primary"><i class="fa fa-print"></i> Print</button></a>
