<?php
	...
	if ($querySimpan) {
		echo "<script> alert('Data Supplier Berhasil Masuk');
		 window.location = '$admin_url'+'mastersupplier/main.php';</script>";
		// jika query gagal, akan tampil alert dan halaman akan diarahkan ke form tambah kategori
	} else {
		echo "<script> alert('Data Supplier Gagal Dimasukkan'); 
		window.location = '$admin_url'+'mastersupplier/form_tambah.php';</script>";
	}
?>