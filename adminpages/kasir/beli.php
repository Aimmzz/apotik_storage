...
if (isset($_POST['simpan'])) {
    ...
    for ($i = 0; $i < $no; $i++) {
        ...
        $id_obat = mysqli_real_escape_string($koneksi, trim($_POST['id_obat'][$i]));
        ...
        $query = "INSERT INTO transaksi VALUES ('', '$id_transaksi', '$id_obat', '$no_nota', '$subtotal', '$qty', '$tanggal', '$total', '$bayar', '$kembalian')";
        $sql = mysqli_query($koneksi, $query);

        // Perbarui stok pada tabel "obat"
        $query_obat = "SELECT stok FROM obat WHERE id_obat = '$id_obat'";
        $result_obat = mysqli_query($koneksi, $query_obat);
        $row_obat = mysqli_fetch_assoc($result_obat);
        $current_stock = $row_obat['stok'];
        $new_stock = $current_stock - $qty;

        $update_query = "UPDATE obat SET stok = '$new_stock' WHERE id_obat = '$id_obat'";
...
<div class="right_col" role="main">
    ...
    <div id="print-div">
        <div class="col-md-5">
            ...
            <h4 align="center">Apotek Alhusna</h4>
            <hr>
            <center>
