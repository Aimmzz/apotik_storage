					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<select class="form-control" id="id-obat" required></select>
							</div>
						</div>
						<div class="col-md-1">
							<div class="form-group">
...
$(window).ready(function(){
	...
	$('#id-obat').select2({
        ajax : {
         ...
         var nm = $("#id-obat option:selected").text();
		 $.ajax({
            type : 'POST',
            url : 'hargaobat.php',
            data : { data : nm },
    ...
    var nmobt = $('#id-obat option:selected').text();
    var harga = $('#harga').val();
    var qty = $('#qty').val();
    var idobt = $('#idobt').val();
    ...
    var list = '<div class="row" id="row' + no + '" style="margin-bottom:10px;">' +
        '<div class="col-md-4">' +
        '<input class="form-control" name="nama_obat[]" id="nama' + no + '" readonly>' +
        '<input type="hidden" name="id_obat[]" id="idobt' + no + '">' +
        '</div>' +
        '<div class="col-md-2">' +
