<?php
	...
	$querySimpan = mysqli_query($koneksi, "UPDATE beli SET id_pembelian='$id_pembelian', id_supplier='$id_supplier',nama_supplier='$nama_supplier',tgl_beli='$tgl_beli', no_bukti='$no_bukti' WHERE id_pembelian='$id_pembelian'");
